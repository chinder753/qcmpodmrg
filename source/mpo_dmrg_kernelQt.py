                        ...
                        for jslc in range(cops.maxslc[0]):
                            for islc in range(cops.maxslc[1]):
                                ...
                                if ista[icase] == -1:
                                    # Flip symmetry
                                    if dmrg.ifs2proj:
                                        rop.qsyms = [-rop.qsyms[0], dmrg.qkey[:1] - rop.qsyms[1],
                                                     dmrg.qkey[:1] - rop.qsyms[2]]
                                    else:
                                        rop.qsyms = [-rop.qsyms[0], dmrg.qkey - rop.qsyms[1], dmrg.qkey - rop.qsyms[2]]
                                    ...
                                    ilen3 = top3[icase].tensordotSYM(top2[icase], top2[icase],
                                                                     axes=([0, 2], [0, 2]))  # T[m'j',mj]
                                    ista[icase] = ilen3
                                if ista[icase] <= 0: continue
